...
cat $BASE_DIR/tmp1 | sed s/DATABASE_ENGINE.*/"DATABASE_ENGINE = \"postgresql\""/g > $BASE_DIR/tmp2
...
#
dpkg-deb --build $BASE_DIR/debian $BASE_DIR/ezweb-platform-postgres_${PKG_VERSION}_all.deb
