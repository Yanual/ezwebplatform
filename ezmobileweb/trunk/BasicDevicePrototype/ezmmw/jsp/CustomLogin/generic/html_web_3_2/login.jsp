...
documentTag.setOpName("CustomLogin");   
...
documentTag.setStyleValues(new String[][]{{"padding","1"},{"margin","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"display-panels-as","plain-flow"},{"panel-links-layout","horizontal"}});
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			imageTag = new ImageTag("Ezweb_Logo","EzWeb");
			imageTag.setStyle("center");
			imageTag.setResourceid("Ezweb_Logo", false );
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			entryfieldTag.setBind("${sessionScope.user}");
			entryfieldTag.setStyle("left login");
			documentTag.addEntryfieldReference( entryfieldTag );
			entryfieldTag.setStyleValues(new String[][]{{"expand","false"},{"readonly","false"},{"required-mark-position","left"},{"maxlength","16"},{"display-as","simulated-disabled"},{"type","text"},{"required","true"},{"align","left"},{"disabled","false"},{"size","8"},{"required-mark","true"},{"required-mark-color","red"}});
			
                if ("none".equals(entryfieldTag.getStyleValue("display"))){                    
                entryfieldTag.setDisplay("false");                    
                }
                
			entryfieldTag.setValue("${sessionScope.user}", true, false );
			...
			entryfieldTag.setBind("${password}");
			entryfieldTag.setStyle("left password");
			documentTag.addEntryfieldReference( entryfieldTag );
			entryfieldTag.setStyleValues(new String[][]{{"expand","false"},{"readonly","false"},{"required-mark-position","left"},{"maxlength","16"},{"display-as","simulated-disabled"},{"type","password"},{"required","true"},{"align","left"},{"disabled","false"},{"size","8"},{"required-mark","true"},{"required-mark-color","red"}});
			
                if ("none".equals(entryfieldTag.getStyleValue("display"))){                    
                entryfieldTag.setDisplay("false");                    
                }
                
			entryfieldTag.setValue("${password}", true, false );
			pTag.addDescendantTag( entryfieldTag );
			}
		bodyTag.addDescendantTag( pTag );
		}
