...
documentTag.setStyleValues(new String[][]{{"padding","1"},{"margin","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"display-panels-as","plain-flow"},{"panel-links-layout","horizontal"}});
		...
		pTag.setStyleValue("layout", "vertical");
			...
			selectTag.setStyleValues(new String[][]{{"required-mark-position","left"},{"display-as","combo"},{"layout","vertical"},{"required","false"},{"multiple","false"},{"dummy-option","true"},{"required-mark","true"},{"required-mark-color","red"}});
