	...
	bodyTag.setStyleValues(new String[][]{{"display-panels-as","plain-flow"},{"panel-links-layout","horizontal"}});
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			chainedMenuTag.setNumMenus(0);
				...
				menuTag.setStyleValues(new String[][]{{"show-menu-separator","false"},{"page-label-type","linktoeachpage"},{"visibility","visible"},{"page-link-range","sequential"},{"page-selected-color","red"},{"page-display-total","false"},{"layout","vertical"},{"menu-separator-char-vertical","|"},{"img-position","left"},{"page-total-color","red"},{"paginate","true"},{"max-rows","9"},{"ordered-list","false"},{"page-controls","only-nextprepage"},{"img-display","both"},{"align","left"},{"pagination-type","nextprepage"},{"page-position","bottom"},{"page-control-type","link"}});
				...
				menuTag.setDynamicInfo("PdaDevice","xhtml_mp","","menu","paginate",wd.getContext());
