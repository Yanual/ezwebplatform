...
documentTag.setStyleValues(new String[][]{{"padding","1"},{"margin","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"color","rgb(148, 105, 16)"},{"display-panels-as","plain-flow"},{"background-color","black"},{"panel-links-layout","horizontal"}});
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			textareaTag.setStyleValues(new String[][]{{"expand","true"},{"readonly","false"},{"required-mark-position","left"},{"display-as","simulated-disabled"},{"required","false"},{"disabled","true"},{"required-mark","true"},{"required-mark-color","red"}});
