...
documentTag.setStyleValues(new String[][]{{"padding","1"},{"margin","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"color","rgb(148, 105, 16)"},{"display-panels-as","plain-flow"},{"background-color","black"},{"panel-links-layout","horizontal"}});
		...
		pTag.setStyleValue("layout", "vertical");
			...
			documentTag.addEntryfieldReference( entryfieldTag );
			entryfieldTag.setStyleValues(new String[][]{{"expand","false"},{"readonly","false"},{"required-mark-position","left"},{"maxlength","16"},{"display-as","simulated-disabled"},{"type","password"},{"required","true"},{"disabled","false"},{"size","8"},{"required-mark","true"},{"required-mark-color","red"}});
