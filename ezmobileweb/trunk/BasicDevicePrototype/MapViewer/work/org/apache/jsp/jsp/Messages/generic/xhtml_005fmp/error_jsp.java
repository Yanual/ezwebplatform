package org.apache.jsp.jsp.Messages.generic.xhtml_005fmp;
...
documentTag.setStyleValues(new String[][]{{"margin","1"},{"padding","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"color","rgb(148, 105, 16)"},{"background-color","rgb(255, 243, 206)"},{"display-panels-as","plain-flow"},{"panel-links-layout","horizontal"}});
		{
		PTag pTag = null;
		pTag = new PTag("p1");
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			imageTag.setStyleValues(new String[][]{{"aspect-ratio","true"},{"align","middle"},{"margin","0"},{"border-width","0"},{"padding","0"},{"display-as","clickable-image"}});
		...
		if (TidMobileTag.isDefined(pTag.getStyleValue("paginate"))){
			...
			actionTag.setStyleValues(new String[][]{{"img-position","left"},{"display-as","link"}});
