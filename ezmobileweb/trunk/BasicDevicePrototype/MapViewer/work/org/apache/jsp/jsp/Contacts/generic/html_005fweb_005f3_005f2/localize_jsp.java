package org.apache.jsp.jsp.Contacts.generic.html_005fweb_005f3_005f2;
...
documentTag.setStyleValues(new String[][]{{"padding","1"},{"margin","1"}});
	...
	bodyTag.setStyleValues(new String[][]{{"color","rgb(148, 105, 16)"},{"display-panels-as","plain-flow"},{"background-color","rgb(255, 243, 206)"},{"panel-links-layout","horizontal"}});
		...
		pTag.setStyleValue("layout", "vertical");
			...
			menuTag.setStyleValues(new String[][]{{"show-menu-separator","false"},{"page-label-type","linktoeachpage"},{"visibility","visible"},{"page-link-range","sequential"},{"page-selected-color","red"},{"page-display-total","false"},{"required","true"},{"layout","vertical"},{"menu-separator-char-vertical","|"},{"img-position","left"},{"page-total-color","red"},{"page-controls","only-nextprepage"},{"autoselect","none"},{"display-as","clickable-image"},{"img-display","both"},{"align","left"},{"pagination-type","nextprepage"},{"page-position","top"},{"page-control-type","link"}});
			...
			menuTag.setDynamicInfo("generic","html_web_3_2","mymem.css","menu","clickable",wd.getContext());
		...
		pTag.setStyleValue("align", "left");
			...
			menuTag.setStyleValues(new String[][]{{"show-menu-separator","false"},{"page-label-type","linktoeachpage"},{"visibility","visible"},{"page-link-range","sequential"},{"page-selected-color","red"},{"page-display-total","false"},{"layout","vertical"},{"menu-separator-char-vertical","|"},{"img-position","left"},{"page-total-color","red"},{"page-controls","only-nextprepage"},{"img-display","both"},{"align","left"},{"pagination-type","nextprepage"},{"page-position","top"},{"page-control-type","link"}});
			...
			menuTag.setDynamicInfo("generic","html_web_3_2","mymem.css","menu","cursorsmobile",wd.getContext());
