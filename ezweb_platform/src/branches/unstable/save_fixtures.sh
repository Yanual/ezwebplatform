...
./manage.py dumpdata --format=xml --indent=4 connectable auth admin contenttypes sessions sites  > connectable/fixtures/initial_data.xml
...
./manage.py dumpdata --format=xml --indent=4 tabspace > tabspace/fixtures/initial_data.xml
