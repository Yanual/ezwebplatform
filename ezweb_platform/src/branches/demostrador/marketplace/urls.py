...
from marketplace.views import PricingCollection, WalletManager, PurchasedCollection, PurchaseGadget, GadgetExpirationCollection#, MarketplaceResourceStatus
...
urlpatterns = patterns('marketplace.views',
    ...
    (r'^expirations/user/(?P<user_name>[_\w]+)$', GadgetExpirationCollection(permitted_methods=('GET',))),
